 ...
 * @description 是否是生产环境
 */
export const IS_PROD = ['production', 'prod', 'uat'].includes(import.meta.env.NODE_ENV);
export const IS_DEV = ['development'].includes(import.meta.env.NODE_ENV);
...
export function shortCode(goodsCode) {
  const code = goodsCode ? goodsCode : '信息错误';
