...
// import { DEPT_SRC_TYPE } from '@/enums/stockKindEnum';
// import ReceiveMyApi from '@/api/dept/receive/my';
// const loginUser = getLoginUser();
// const deptId = loginUser.mgrRangeId;
// const userId = loginUser.uxid;

//查询库区
const getShelf = async () => {
  // const res = await ReceiveMyApi.queryStockShelfList({ deptId, userId });
  // return res.data;
  return [];
};

const optionTask = [{ val: '', desc: '全部', type: 0 }] as any[];
...
export const schemas00: FormSchema[] = [
  {
    field: 'divider-basic',
    component: 'Divider',
    label: '基础字段',
